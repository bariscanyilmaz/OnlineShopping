namespace DataAccesLAYER_DAL_
{
    ...
    public class ShopContext : DbContext
    {
        ...
        // 'DataAccesLAYER_DAL_.ShopContext' database on your LocalDb instance. 
        // 
        ...
        public virtual DbSet<ShopHistory> ShopData { get; set; }
    ...
    public class Configuration:CreateDatabaseIfNotExists<ShopContext>
    {
        ...
        protected override void Seed(ShopContext context)
        {
            ...
            context.Product.AddRange( new Product[] {
                new Product(){Name="HoloLens",Image="Holo.jpg",Price=1500},
                new Product(){Name="PS4",Image="ps4.jpg",Price=300},
                new Product(){Name="Xbox",Image="xbox.jpg",Price=250}
